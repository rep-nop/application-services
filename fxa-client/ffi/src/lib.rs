...
use fxa_client::{Config, FirefoxAccount, PersistCallback, errors::Result};
use fxa_client::ffi::*;
...
pub unsafe extern "C" fn fxa_register_persist_callback(
    ...
    call_with_result(error, AssertUnwindSafe(|| -> Result<_> {
...
pub extern "C" fn fxa_profile(
    ...
    call_with_result(error, AssertUnwindSafe(|| {
